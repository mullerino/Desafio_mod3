...
texto10 = 'Observando esse gráfico, nota-se que tal porcentagem é maior para as cidades do interior, como por exemplo na cidade de Campinas, a qual cerca de 20% da população contraiu o vírus. Por fim, conclui-se que há uma diferença entre as medidas tomadas nas cidades da metrópole em relação as cidades do interior, mesmo na capital de SP, a qual possui uma população extremamente grande, não existiu uma alta porcentagem de casos registrados'
texto11 = 'Portanto, o problema observado é a questão do excesso de atenção para as cidades metropolitanas e o "esquecimento" das demais cidades do Estado.'
